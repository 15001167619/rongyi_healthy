package health.examination.one.cache;
...
public class RedisUtil {
    ...
    public void setStrOps(RedisStringOperations strOps) {
        this.strOps = strOps;
    }
     ...
     * @return
     */
    public Set<String> getByPre(String keys) {
     ...
     * @return
     */
    public Long delPre(String keys) {
        Set<String> set = getByPre(keys);
        int result = set.size();
    ...
    public boolean validCode(String phone, String code){
        ...
        String key = phone;
        String oldCode = getStrOps().get(key);
    ...
    private String getOrderPrefix(Date date) {
        ...
        prefix.append(new SimpleDateFormat("yyyyMMdd").format(new Date())).append(dayFmt).append(hourFmt);
    ...
    private Long incrOrderId(String biz, String prefix) {
        String orderId = null;
        String key = "geese:#{biz}:id:".replace("#{biz}", biz).concat(prefix);
        try {
